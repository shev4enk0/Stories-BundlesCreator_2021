...
TextAsset _book = Resources.Load<TextAsset>("JSON/Fantasy");

AJFile _json_obj = JsonConvert.DeserializeObject<AJFile>(_book.text);

List<AJObj> Models = _json_obj.Packages[0].Models;
